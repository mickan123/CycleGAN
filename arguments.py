...
def parse_arguments():
	...
	parser.add_argument("-mb", "-mb_size",
						...
						default = 64)
	parser.add_argument("-da", "-data_dir_a",
						help = "Dataset directory location for dataset a",
						default = "data/faces")
	parser.add_argument("-db", "-data_dir_b",
						help = "Dataset directory location for dataset b",
						default = "data/celeb_images_10000")
